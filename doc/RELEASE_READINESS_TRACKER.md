...
| Audit confidence | Static RN/source parity, artifact pinning, Dart LSP/network behavior, support-safe LSP diagnostics, package metadata checks, typed Pigeon wire-envelope transport, internal-beta supply-chain/license/vulnerability/ABI inventory, clean consumer install/archive builds, Android JVM bridge tests, iOS XCTest bridge tests, funded/unfunded platform smokes, external-signer process restart, Group 4 package/platform fixes, Group 5 codebase/docs/coverage hardening, Group 6 release-runner hardening, Group 7 structured provenance gating, Group 8 lifecycle/cleanup hardening, current facade/lifecycle/unit/timeout/platform-abstraction/crypto-gating hardening, and beta.27/core beta.7 LSP/API/model catch-up are verified on exact clean commit `9e774b98970e45e66c2bbc4e7d5b5d517fd6f08f`. The current static RN/source validator checks live RN `origin/dev` drift and passes against beta.27/core beta.7. The full release-candidate run `20260806T094500Z` reports `releaseEligible: true` and `dirty: false`. Release verdict remains NO-GO until PKG-006 is verified or explicitly accepted |
...
but there is still 1 open finding and no unresolved decisions. Upstream
production provenance remains the release blocker. P0
completion removes
...
| `flutter test --coverage` | Pass, 167 tests; Dart package coverage 78.0% | Dart unit/contract tests pass and the Group 5 coverage floors pass; native RLN behavior is covered by the native/platform reports below |
...
| `dart run tool/validate_public_api_docs.dart` | Pass: 185 stable root symbols | Every root-exported stable symbol is listed in `doc/PUBLIC_API_REFERENCE.md`; the validator also forbids known advanced/RN/raw symbols from the stable root |
...
| iOS XCTest bridge suite | Pass, 16 cases | Current source graph, exact storage policy, typed Pigeon wire envelope, detach cleanup, background Pigeon queue generation, timeout/lifecycle cleanup, structured error taxonomy, and UUID destination path passed on iPhone Air simulator `46B8C95D-F0CD-4E50-9C98-61A8F84176AB`; report `build/test-reports/release/native-ios-46B8C95D-F0CD-4E50-9C98-61A8F84176AB-20260806T094500Z-9e774b9.json` |
| Android JVM bridge suite | Pass, 18 cases | Current plugin/storage-policy, typed Pigeon wire envelope, detach cleanup, artifact verification, timeout/lifecycle cleanup, structured error taxonomy, and request-boundary cases passed against RLN `0.10.0-beta.3`; report `build/test-reports/release/native-android-20260806T094500Z-9e774b9.json` |
| iOS external-signer process restart | Pass | Clean run `20260806T094500Z`; one installed simulator binary crossed prepare/verify process boundary and passed trusted virtual BTC-channel restart proof; report `build/test-reports/release/external-signer-restart-46B8C95D-F0CD-4E50-9C98-61A8F84176AB-20260806T094500Z-9e774b98970e.json` |
| Android external-signer process restart | Pass | Clean run `20260806T094500Z`; one installed APK crossed prepare/verify process boundary and passed trusted virtual BTC-channel restart proof on `emulator-5554`; report `build/test-reports/release/external-signer-restart-emulator-5554-20260806T094500Z-9e774b98970e.json` |
| Current general funded/unfunded platform smokes | Pass | iOS unfunded, iOS funded RGB+Lightning, Android unfunded, and Android funded RGB+Lightning smokes all passed from the exact clean candidate using the SDK regtest stack on RGB proxy port `3013`; reports are under `build/test-reports/release/` for run `20260806T094500Z` |
| Combined release-candidate script | Pass, release eligible on clean commit `9e774b9` | Run `20260806T094500Z` passed 31 package/static gates, clean consumer path/Git Android+iOS archives, native Android JVM, native iOS XCTest, iOS/Android unfunded smokes, iOS/Android funded RGB+Lightning smokes, and iOS/Android external-signer process restart; report `build/test-reports/release/release-candidate-20260806T094500Z-9e774b9.json` has `releaseEligible: true` and `dirty: false` |
...
| G-09 Test evidence | Passed current exact-candidate gate | Contract, native, restart, failure, funded/unfunded, and cross-platform tests passed on exact clean commit `9e774b98970e45e66c2bbc4e7d5b5d517fd6f08f` with `releaseEligible: true` and `dirty: false` |
...
| BASE-008 | P1 | Verified | Upstream RN `dev` is `63cbf9a01030a8a10eb1b04b2734cd8c5d23aec1`, package `1.0.0-beta.27`, core `1.0.0-beta.7`, and RLN `0.10.0-beta.3`; Flutter now targets the same source/artifact baseline and verifies generated constants, installed iOS files, iOS archive, Android AAR, static RN parity, and exact clean native/platform release evidence on commit `9e774b98970e45e66c2bbc4e7d5b5d517fd6f08f`. | Keep baseline pins and exact evidence refreshed whenever RN/core/RLN changes. |
...
| API-032 | P1 | Verified | External-signer wallets expose false RGB UTXO/issuance capabilities, fail fast before native calls, and the approved trusted virtual BTC-channel external-signer regression now passes on the exact clean beta.27/core beta.7 candidate. | Exact clean run `20260806T094500Z` on commit `9e774b98970e45e66c2bbc4e7d5b5d517fd6f08f` produced release-eligible iOS and Android external-signer restart reports with `dirty: false`: `external-signer-restart-46B8C95D-F0CD-4E50-9C98-61A8F84176AB-20260806T094500Z-9e774b98970e.json` and `external-signer-restart-emulator-5554-20260806T094500Z-9e774b98970e.json`. |
...
| TEST-002 | P1 | Verified | The release candidate now has layered contract, native, and end-to-end runtime evidence on the exact clean commit: Dart/package tests, Android JVM bridge tests, iOS XCTest bridge tests, clean consumer path/Git archives, iOS/Android unfunded smokes, iOS/Android funded RGB+Lightning smokes, and iOS/Android external-signer restart proofs. | Exact clean run `20260806T094500Z` on commit `9e774b98970e45e66c2bbc4e7d5b5d517fd6f08f` produced `releaseEligible: true`, `dirty: false` in `build/test-reports/release/release-candidate-20260806T094500Z-9e774b9.json`. |
...
| TEST-013 | P1 | Verified | Android JVM bridge tests, iOS XCTest bridge tests, iOS unfunded, iOS funded, Android unfunded, Android funded, and the all-up `RUN_PLATFORM=1` local release-candidate script passed on exact clean candidate `9e774b98970e45e66c2bbc4e7d5b5d517fd6f08f` against the current beta.27/core beta.7/RLN 0.10.0-beta.3 artifacts and regtest stack. | Keep rerunning this exact stack for every release-candidate commit; dirty reports remain non-release evidence. |
...
| TEST-028 | P1 | Verified | The exact clean current-candidate release run now covers the beta.27/core beta.7 target after lifecycle/API/error/docs fixes. Run `20260806T094500Z` on commit `9e774b98970e45e66c2bbc4e7d5b5d517fd6f08f` passed 31 release-runner steps, including package/static gates, clean consumer path/Git Android+iOS archives, native Android JVM, native iOS XCTest, iOS/Android funded and unfunded regtest smokes, and iOS/Android external-signer restart. | `build/test-reports/release/release-candidate-20260806T094500Z-9e774b9.json` reports `status: passed`, `releaseEligible: true`, and `workingTree.dirty: false`; all child reports for the same run are also `passed`, `releaseEligible: true`, and `dirty: false`. |
