...
All repository-owned correctness, API, model, lifecycle, security, packaging,
testing, and documentation findings are implemented or explicitly accepted
